...
- [Exercise 6.1](./README.md#exercise-61---go-through-pre-built-integration-flow-to-summarize-the-current-status-of-the-customer-using-generative-ai-hub-optional) (Optional) Go through a pre-built Integration Flow that performs a semantic search on the HANA Vector DB and summarizes the current status for the custmer using an AI Adapter and  Generative AI Hub.
...
1. You can view the pre-built Integration Flow by loggin into the Integration Suite tenant that you used earlier in Exercises 3 and 4.
   <br><br>
...
3. Go through the steps to understand it
   ...
   2. The user input (entered in Joule) is send to AI Core for generation of embeddings. The same embedding model we used in Exercise 3 and 4 (`text-embedding-3-small`) will be used
