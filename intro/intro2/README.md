...
Details about the [Sales Order Events](https://api.sap.com/event/CE_SALESORDEREVENTS/overview) and [Sales Order API](https://api.sap.com/api/CE_SALESORDER_0001/overview) can be found in the [SAP Business Accelerator Hub](https://api.sap.com/).
