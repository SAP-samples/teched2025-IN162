...
Now, to learn all the configurations that has been done in **SAP S/4HANA Cloud** to enable new sales order event publication to **SAP Integration Suite, advanced event mesh**, you can navigate to [SAP S/4HANA Cloud System Configuration](/intro/intro2/README.md) section.
