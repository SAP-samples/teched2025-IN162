...
- [Exercise 3 - Integration Suite – Iflow S4Hana Sales Order to Embedding Model to SAP Hana Vector DB](exercises/ex3/)
    - [Exercise 3.1 - Create a package and an IFlow in your designated tenant](exercises/ex3#exercise-31---create-a-package-and-an-iflow-in-your-designated-tenant)
    - [Exercise 3.2 - Create a new Sales Order in S/4Hana Cloud system](exercises/ex3#exercise-32---create-a-new-sales-order-in-s4hana-cloud-system)
